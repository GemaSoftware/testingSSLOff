...
class WebEnginePage(QWebEnginePage):
    def certificateError(self, error):
        # This will supress all https errors and load the website regardless
...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.browser.load(QUrl('https://127.0.0.1:5000'))
    ...
    def home(self):
        self.browser.setUrl(QUrl('https://gemasoftware.com'))
...
QApplication.setApplicationName('GemaSoftwares Web Browser')
